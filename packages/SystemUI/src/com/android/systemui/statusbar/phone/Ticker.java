...
public abstract class Ticker implements DarkReceiver {
    ...
    public Ticker(Context context, View tickerLayout) {
        ...
        animationIn = AnimationUtils.loadAnimation(context, com.android.internal.R.anim.push_up_in);
        animationOut = AnimationUtils.loadAnimation(context, com.android.internal.R.anim.push_up_out);
