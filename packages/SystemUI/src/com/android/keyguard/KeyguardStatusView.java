...
public class KeyguardStatusView extends GridLayout implements
    ...
    private void updateWeatherSettings() {
        ...
        int primaryTextColor = res.getColor(R.color.keyguard_default_primary_text_color);
    ...
    class SettingsObserver extends ContentObserver {
         ...
         void observe() {
             ...
             resolver.registerContentObserver(Settings.System.getUriFor(
                     Settings.System.HIDE_LOCKSCREEN_WEATHER), false, this, UserHandle.USER_ALL);
             resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.OMNIJAWS_WEATHER_ICON_PACK), false, this, UserHandle.USER_ALL);
             resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.HIDE_LOCKSCREEN_WEATHER_LOCATION), false, this, UserHandle.USER_ALL);
         ...
         public void onChange(boolean selfChange, Uri uri) {
             if (uri.equals(Settings.System.getUriFor(
                     Settings.System.HIDE_LOCKSCREEN_WEATHER))) {
                 queryAndUpdateWeather();
             } else if (uri.equals(Settings.System.getUriFor(
                     Settings.System.OMNIJAWS_WEATHER_ICON_PACK))) {
                 queryAndUpdateWeather();
             }  else if (uri.equals(Settings.System.getUriFor(
                     Settings.System.HIDE_LOCKSCREEN_WEATHER_LOCATION))) {
                 queryAndUpdateWeather();
             }
             update();
         }
         ...
         public void update() {
           ...
           mShowWeather = Settings.System.getInt(resolver,
                Settings.System.HIDE_LOCKSCREEN_WEATHER, 0) == 1;
           showLocation = Settings.System.getInt(resolver,
                Settings.System.HIDE_LOCKSCREEN_WEATHER_LOCATION, 1) == 1;
